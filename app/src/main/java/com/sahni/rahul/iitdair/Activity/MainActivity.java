package com.sahni.rahul.iitdair.Activity;
...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, ErrorListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            getSupportFragmentManager().beginTransaction().add(R.id.main_frame_layout, HomeFragment.newInstance(), "Home")
            .commit();
        }
